export type ProductVariant = { id: string; label: string; priceRsd: number };
...
export type Product = {
  ...
  shortDescription: string; description: string; priceRsd: number; compareAtPriceRsd?: number | null;
